  ...
  return keccak256(
    encodeAbiParameters(
      ...
      [
        ...
        message.daskiCommissionReceiver, message.commissionBps,
...
export async function validateCompatibilityListing(
  ...
  const uints = [
    ...
    message.commissionBps, message.issuedAt, message.validBefore,
  ];
  if (
